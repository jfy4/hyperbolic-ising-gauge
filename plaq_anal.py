...
if __name__ == '__main__':
    ...
    print("plaq num", len(boundary_plaqs))
    num_sources = len(boundary_plaqs)
...
#    assert False
    ...
    np.save("./plaqL" + L + "/hb_wilson_loop_b" + str(beta).replace('.', 'p') + "_L" + L + ".npy", wl_array)
    np.save("./plaqL" + L + "/hb_domain_b" + str(beta).replace('.', 'p') + "_L" + L + ".npy", dom_array)
    # np.save("./plaqL" + L + "/hb_pcorr_b" + str(beta).replace('.', 'p') + "_L" + L + ".npy", corr_array)
